<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Report.aspx.vb" Inherits="Business_Report" %>
        ...
        <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
          <Columns>
                <asp:TemplateField HeaderText="S.No">
                    <ItemTemplate >
                    <asp:Label runat="server" ID="SNo" Text="1"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="Lorry" HeaderText="Lorry Details" 
                     />  
                <asp:BoundField DataField="LorryGroup" HeaderText="Lorry Group" 
                     />  
